...
import {
   notification, notificationByIdUser, notificationsToLevel, notificationsCountFromUser, addNewNotification, editNotification
...
const resolvers = {
   Query: {
      ...
      notificationsCountFromUser,      //returns the total amount of notifications received by the user
